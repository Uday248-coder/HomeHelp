      ...
      <div className="p-6 lg:p-8 space-y-6 animate-fade-in">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
          <section className="card-dashboard p-6">
            <h2 className="text-base font-semibold text-foreground mb-4">Weekly Revenue</h2>
            <BarChart data={revenueData} />
          </section>

          <section className="card-dashboard p-6">
            <h2 className="text-base font-semibold text-foreground mb-4">Booking Status</h2>
            <DonutChart
              data={[
